...
public class BrowserOneActivity extends StatusBarActivity {
	/**
	...
	private void init() {
		...
		mWebView.setWebViewClient(new WebViewClient() {
			...
			public void onPageFinished(WebView webView, String s) {
				...
				//修改标题
                mWebView.loadUrl(CommentUtl.setTitle(intentTitle));
				webView.loadUrl(CommentUtl.getClearAdDivJs(BrowserOneActivity.this));
				clearAD(webView);
			}
	...
	private void clearAD(WebView webView) {
		//webView.loadUrl("javascript:document.getElementsByTagName('div')[2].style.display = 'none';");
		//webView.loadUrl("javascript:document.getElementsByTagName('div')[2].style.display = 'none';");
	}
	...
	protected void setUpView() {
		super.setUpView();
		ToastUtils.showCenter(BrowserOneActivity.this,getResources().getString(R.string.brow));
	}
