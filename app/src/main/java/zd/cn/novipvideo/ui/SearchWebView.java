...
public class SearchWebView extends StatusBarActivity {
    /**
    ...
    private void init() {
        ...
        mWebView.loadUrl(Url.loadUrl[position]);
    ...
    protected void initView() {
        ...
        titleBar.setLeftImg(R.mipmap.frag_close);
