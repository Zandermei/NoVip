package zd.cn.novipvideo.widget.control;
...
import zd.cn.novipvideo.utils.TimeFormater;
...
import zd.cn.novipvideo.widget.quality.QualityItem;
...
//        } zdd
    ...
    private void updateScreenModeBtn() {
        if (mAliyunScreenMode == AliyunScreenMode.Full) {
            mScreenModeBtn.setImageResource(R.mipmap.alivc_screen_mode_smalll);
        } else {
