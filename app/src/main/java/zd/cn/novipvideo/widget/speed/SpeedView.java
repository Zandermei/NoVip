package zd.cn.novipvideo.widget.speed;
...
public class SpeedView extends RelativeLayout implements ITheme {
    ...
    //选中的倍速的指示点的方块
    private int mSpeedDrawable = R.mipmap.alivc_speed_dot_blue;
    //选中的倍速的指示点的文字
...
//监听view的Layout事件
    ...
    public void setTheme(AliyunVodPlayerView.Theme theme) {
        ...
        mSpeedDrawable = R.mipmap.alivc_speed_dot_blue;
        ...
        if (theme == AliyunVodPlayerView.Theme.Blue) {
            ...
            mSpeedDrawable = R.mipmap.alivc_speed_dot_green;
            mSpeedTextColor = R.color.alivc_green;
        } else if (theme == AliyunVodPlayerView.Theme.Orange) {
            mSpeedDrawable = R.mipmap.alivc_speed_dot_orange;
            mSpeedTextColor = R.color.alivc_orange;
        } else if (theme == AliyunVodPlayerView.Theme.Red) {
            mSpeedDrawable = R.mipmap.alivc_speed_dot_red;
