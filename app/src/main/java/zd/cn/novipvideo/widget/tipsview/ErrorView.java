package zd.cn.novipvideo.widget.tipsview;
...
public class ErrorView extends RelativeLayout implements ITheme {
    ...
    public void setTheme(AliyunVodPlayerView.Theme theme) {
        if (theme == AliyunVodPlayerView.Theme.Blue) {
            ...
            mRetryBtn.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.alivc_refresh_blue, 0, 0, 0);
            ...
            mRetryBtn.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.alivc_refresh_green, 0, 0, 0);
            ...
            mRetryBtn.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.alivc_refresh_orange, 0, 0, 0);
            ...
            //这个重试图片是白色。。很尴尬
            mRetryBtn.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.alivc_refresh_red, 0, 0, 0);
