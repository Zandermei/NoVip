package zd.cn.novipvideo.widget.more;
...
import zd.cn.novipvideo.ui.VideoPlayAliActivity;
...
//    private TextView tvCastScreen;zdd 下载投屏屏蔽
//    private TextView tvBarrage;

    private TextView scalModelOne;//自适应
    private TextView scalModelTwo;//填充
    private TextView scalModelThree;//原始大小
    ...
    public ShowMoreView(VideoPlayAliActivity context, AliyunShowMoreValue moreValue) {
        super(context);
...
//        tvBarrage = view.findViewById(R.id.tv_barrage);
        scalModelOne = view.findViewById(R.id.scal_modeo);
        scalModelTwo = view.findViewById(R.id.scal_modet);
        scalModelThree = view.findViewById(R.id.scal_modeoth);
...
//        tvBarrage.setOnClickListener(this);
        scalModelOne.setOnClickListener(this);
        scalModelTwo.setOnClickListener(this);
        scalModelThree.setOnClickListener(this);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.scal_modeo) {
            //自适应  SCALE_ASPECT_FIT
            if(playScalModel != null){
                playScalModel.onVideoScalModel(IPlayer.ScaleMode.SCALE_ASPECT_FIT);
            }
...
//            }
        } else if (id == R.id.scal_modet) {
            //填充屏幕
            if(playScalModel != null){
                playScalModel.onVideoScalModel(IPlayer.ScaleMode.SCALE_TO_FILL);
            }
//            // 投屏
...
//            }
        ...
        } else if (id == R.id.scal_modeoth) {
            //拉伸
            if(playScalModel != null){
                playScalModel.onVideoScalModel(IPlayer.ScaleMode.SCALE_ASPECT_FILL);
            }
//            // 弹幕
...
//            }
    ...
    public interface OnAliVodPlayScalModel{
        void onVideoScalModel(IPlayer.ScaleMode mode);
    }
    private OnAliVodPlayScalModel playScalModel;
    public void setAliPlayScalModeListener(OnAliVodPlayScalModel listener){
        this.playScalModel = listener;
    }
