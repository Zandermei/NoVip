...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private TextView tabForeTextView;

    private String text_one;
    private String text_two;
    private String text_three;
    private String getText_four;
    ...
    private Drawable selectTabOneButtonIcon;
    private Drawable selectTabTwoButtonIcon;
    private Drawable selectTabThreeButtonIcon;
    private Drawable selectTabFourButtonIcon;
    private Drawable selectTabFiveButtonIcon;
    ...
    private void init() {
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.video_ic);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_smike);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_my);
        defaultTabFourButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_my);
        defaultTabFiveButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_tab_five);

        selectTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.video_ic);
        selectTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_smike);
        selectTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_my);
        selectTabFourButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_my);
        selectTabFiveButtonIcon = getContext().getResources().getDrawable(R.drawable.ic_movie);

        defaultTextColor = ContextCompat.getColor(getContext(), R.color.white);

        defaultButtonColor = ContextCompat.getColor(getContext(), R.color.toorBar);

        defaultTabColor = ContextCompat.getColor(getContext(), R.color.imgBar);
    }
    ...
    public void initialize(ViewPager viewPager, FragmentManager fragmentManager, List<Fragment> fragments) {
        if (numberOfTabs < fragments.size() || numberOfTabs > fragments.size())
            throw new IllegalArgumentException("You have " + numberOfTabs + " tabs."+"-有-"+fragments.size());
        ...
        if (numberOfTabs == 3 && !iconOnly) {
            tabOne.setCustomView(R.layout.icon_text_tab_search);
            tabTwo.setCustomView(R.layout.icon_text_tab_video);
            tabThree.setCustomView(R.layout.icon_text_tab_movie);
           // tabFour.setCustomView(R.layout.icon_text_tab_account);
          ...
          //  tabs.add(tabFour);
            ...
            tabOneTextView = (TextView) tabOne.getCustomView().findViewById(R.id.tabTextView_lock);
            tabTwoTextView = (TextView) tabTwo.getCustomView().findViewById(R.id.tabTextView_store);
            tabThreeTextView = (TextView) tabThree.getCustomView().findViewById(R.id.tabTextView_notify);
           // tabForeTextView = (TextView) tabFour.getCustomView().findViewById(R.id.tabTextView_account);


            tabOneImageView = (ImageView) tabOne.getCustomView().findViewById(R.id.tabImageView_search);
            tabTwoImageView = (ImageView) tabTwo.getCustomView().findViewById(R.id.tabImageView_video);
            tabThreeImageView = (ImageView) tabThree.getCustomView().findViewById(R.id.tabImageView_movie);
          //  tabFourImageView = (ImageView) tabFour.getCustomView().findViewById(R.id.tabImageView_account);
            ...
            tabTwo.setCustomView(R.layout.icon_text_tab_video);
            tabThree.setCustomView(R.layout.icon_text_tab_movie);
            if (numberOfTabs > 3) tabFour.setCustomView(R.layout.icon_text_tab_account);
            if (numberOfTabs > 4) tabFive.setCustomView(R.layout.icon_text_tab_account);
            ...
            if (numberOfTabs > 3)
                tabFourImageView = (ImageView) tabFour.getCustomView().findViewById(R.id.tabImageView_account);
            if (numberOfTabs > 4)
                tabFiveImageView = (ImageView) tabFive.getCustomView().findViewById(R.id.tabImageView_account);
       }
    ...
    private void moveTab(List<Integer> tabSize, int position) {
        if (!tabSize.isEmpty()) {
            ...
            switch (position) {
                case 0:
                    actionButton.setImageDrawable(selectTabOneButtonIcon);
                    actionButton.setOnClickListener(tabOneOnClickListener);
                    break;
                case 1:
                    actionButton.setImageDrawable(selectTabTwoButtonIcon);
                    actionButton.setOnClickListener(tabTwoOnClickListener);
                    break;
                case 2:
                    actionButton.setImageDrawable(selectTabThreeButtonIcon);
                    actionButton.setOnClickListener(tabThreeOnClickListener);
                    break;
                case 3:
                    actionButton.setImageDrawable(selectTabFourButtonIcon);
                    actionButton.setOnClickListener(tabFourOnClickListener);
                    break;
                case 4:
                    actionButton.setImageDrawable(defaultTabFiveButtonIcon);
